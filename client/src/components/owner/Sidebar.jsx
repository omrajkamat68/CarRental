  ...
  return (
    <div className='relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
        ...
        <div className='group relative'>
          <label htmlFor="image">
            <img src={image ? URL.createObjectURL(image) : user?.image || "https://www.google.com/url?sa=i&url=https%3A%2F%2Funsplash.com%2Fs%2Fphotos%2Fprofile&psig=AOvVaw1x4mT7l4jBbjS7Hri39Uc8&ust=1753501018277000&source=images&cd=vfe&opi=89978449&ved=0CBUQjRxqFwoTCOjA7cGK144DFQAAAAAdAAAAABAE"} alt="" className='h-9 md:h-14 w-9 md:w-14 rounded-full mx-auto' />
